def CameraNotWorking(df_sitemas,df_vboxattendance):
    ...
    def transformation(df_sitemas,df_vboxattendance):
        ...
        if len(df_vboxattendance)>0:
            ...
            df_no_recording=df_vboxattendance[df_vboxattendance['last_record']>5]

            df_recording_now=df_recording[df_recording['Status']=='1']
            df_no_recording2=df_recording[df_recording['Status']=='-1']

            df_not_recording=pd.concat([df_no_recording,df_no_recording2],ignore_index=True)
            ...
            df_closed=df_cam_issue[df_cam_issue['SiteName'].isin(df_recording_now['SiteName'])]
