...
def main(ServerAddress,UserName,Password,DatabaseName):
    ...
    def events_db(ServerAddress,UserName,Password,DatabaseName):
    ...
    def transformation(df_attendance,df_sitemas,df_events_dictionary,df_items,Today):
        ...
        SensorName=['08','09','10','11','65','66','67','12','13','14','15','75','76','77','32','33','36','56']
        ...
        df_output.rename(columns={'Lobby Motion Detector':'Lobby Movement Sensor','Back Room Door Contact Sensor':'Backroom Door Sensor','Battery Bank Location Sensor':'ATM1 Battery Bank Location Sensor','ATM1 Hood Contact Sensor':'ATM1 Hood Sensor'},inplace=True)
        df_output1.rename(columns={'Lobby Motion Detector':'Lobby Movement Sensor','Back Room Door Contact Sensor':'Backroom Door Sensor','Battery Bank Location Sensor':'ATM1 Battery Bank Location Sensor','ATM1 Hood Contact Sensor':'ATM1 Hood Sensor'},inplace=True)
    ...
    df_attendance,df_sitemas,df_events_dictionary,df_items,Today=events_db(ServerAddress,UserName,Password,DatabaseName)
...
df_output,df_output1=main(ServerAddress,UserName,Password,DatabaseName)