...
def main(ServerAddress,UserName,Password,DatabaseName):
    ...
    def fetch_and_transform(ServerAddress,UserName,Password,DatabaseName):
        ...
        df_sensor_problem['problemed_sensors']=(18-df_sensor_problem.iloc[:,8:].isnull().sum(axis=1))
        ...
        df_sensor_problem2['problemed_sensors']=(18-df_sensor_problem2.iloc[:,8:].isnull().sum(axis=1))
